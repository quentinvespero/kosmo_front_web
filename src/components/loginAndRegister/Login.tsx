...
const Login:React.FC<LoginAndRegisterPanelsProps> = ({setSelectedPanel, setFieldsValues}) => {
    ...
    return (
        <div className='login loginAndRegister-panels'>
            ...
            <LoginAndRegisterField textDescription='Mail address' fieldType='text' placeHolderValue='Type your mail address' onChange={(e:React.ChangeEvent<HTMLInputElement>) => handleFieldChange(e, setFieldsValues)} name='mailAddress' />
            <LoginAndRegisterField textDescription='Password' fieldType='password' placeHolderValue='Type your password' onChange={(e:React.ChangeEvent<HTMLInputElement>) => handleFieldChange(e, setFieldsValues)} name='password' />
